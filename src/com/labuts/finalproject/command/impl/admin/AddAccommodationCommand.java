...
/**
 * Create AddAccommodationCommand from Command
 */
public class AddAccommodationCommand extends Command {
    ...
    public String execute(HttpServletRequest request) {
        ...
        if((int)session.getAttribute(ROLE_PARAMETER) == ADMIN_STATUS) {
            ...
            if(validator.isValidAccommodationName(accommodationName) && validator.isValidAccommodationDescription(accommodationDescription)
                ...
                try {
                    adminService.addAccommodation(accommodationName, accommodationDescription, accommodationCost);
                ...
                Accommodation accommodation = new Accommodation(0);
